...
**Adding one:** take it from the same repo, same 3D style, save it here at 256px,
and add the row to `REACTION_ART`. Skin-toned emoji live under a `Default/`
folder; everything else does not.
