...
export function EditorToolbarV2(props: EditorToolbarV2Props) {
  ...
  const sep = () => <div class="w-px h-5 bg-gray-600 mx-0.5" />

  return (
    <Show when={props.editor()}>
      {(editor) => (
        <div class="flex flex-wrap items-center gap-0.5 px-2 py-1.5 bg-[#2c2c2e] border-b border-gray-700">
          {/* Text formatting */}
          <button
            type="button"
          ...
          <button
            type="button"
            class={btn(editor().isActive('highlight'))}
