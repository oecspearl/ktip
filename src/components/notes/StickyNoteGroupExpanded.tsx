      ...
      >
        ...
        >
          ...
          <span className="text-xs opacity-70">
            <Plural value={members.length} one="# note" other="# notes" />
          </span>
          <button
            type="button"
        ...
        {confirming ? (
          <div className="p-6">
            <p className="text-sm font-semibold"><Trans>Ungroup this folder?</Trans></p>
            <p className="mt-1 text-sm opacity-75">
              <Trans>Keeping the notes puts all {members.length} back on the page. Deleting removes them for good.</Trans>
            </p>
          ...
          <div className="grid flex-1 grid-cols-2 gap-3 overflow-y-auto p-4">
            {members.map((note) => (
              <button
                ...
                title={t`Take this note out of the folder`}
