...
export const GETTING_STARTED_CATEGORY: HelpCategory = {
  ...
  articles: [
    ...
    },
    {
      ...
      tags: ['roles', 'student', 'mentor', 'investor', 'entrepreneur', 'faculty', 'researcher', 'permissions', 'tiers'],
    },
    {
      id: 'acting-as-role',
