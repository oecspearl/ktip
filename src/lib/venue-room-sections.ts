...
export const SECTIONS: RoomSectionDef[] = [
  ...
  {
    id: 'sponsor_hero',
    label: msg`Sponsor banner`,
    blurb: msg`Logo and link for whoever is hosting the room. Hides itself when there is no sponsor.`,
    slot: 'main',
  ...
  },
  {
    id: 'check_in',
    label: msg`Check in`,
    blurb: msg`Lets a registered attendee mark themselves present. Hides once they have.`,
    slot: 'main',
    defaultFor: [],
    order: 15,
  },
  {
    id: 'host_controls',
    label: msg`Host controls`,
    blurb: msg`Announce to the room, or close it. Only organizers ever see this.`,
    slot: 'main',
    roles: ['organizer'],
    defaultFor: 'all',
    order: 18,
  },
  {
    ...
    blurb: msg`The call. Until LiveKit lands it says so, rather than looking broken.`,
    slot: 'main',
    defaultFor: 'all',
    order: 20,
  },
  {
    id: 'reactions',
    label: msg`Reactions`,
    blurb: msg`A row of emoji everyone in the room sees. Nothing is stored.`,
    slot: 'main',
  ...
  {
    id: 'focus_timer',
    label: msg`Focus timer`,
    blurb: msg`A private countdown for a heads-down room. Nobody else sees it.`,
    slot: 'main',
    defaultFor: [],
    order: 24,
  },
  {
    id: 'objectives',
    label: msg`What this room is for`,
    blurb: msg`Your own text. Falls back to the room description if you write none.`,
    slot: 'main',
  ...
  {
    id: 'challenge_brief',
    label: msg`The challenge`,
    blurb: msg`Objectives, constraints, deliverables and judging weights. Hidden if the event has no brief.`,
    slot: 'main',
  ...
  },
  {
    id: 'showcase_gallery',
    label: msg`Entries`,
    blurb: msg`What has been submitted, and the form to submit. Who sees whose entry is decided by RLS.`,
    slot: 'main',
    defaultFor: ['stage'],
    order: 40,
  },
  {
    id: 'resources',
    label: msg`Files`,
    blurb: msg`Everything attached to the event. Who may open what is unchanged.`,
    slot: 'main',
    defaultFor: ['workshop'],
    order: 45,
  },
  {
    id: 'chat',
    label: msg`Chat`,
    blurb: msg`Everyone in the room can post.`,
    slot: 'main',
    defaultFor: 'all',
    order: 50,
  },
  {
    ...
    label: msg`Announcements only`,
    blurb: msg`The same chat, but only organizers may post. Use instead of Chat, not alongside it.`,
    slot: 'main',
    defaultFor: [],
    order: 60,
  },
  {
    id: 'faq',
    label: msg`Common questions`,
    blurb: msg`The event page’s FAQ, repeated here. Hidden if there is none.`,
    slot: 'main',
  ...
  {
    id: 'rules',
    label: msg`House rules`,
    blurb: msg`Your own text — conduct, ground rules, what this room is not for.`,
    slot: 'main',
    defaultFor: [],
    order: 80,
  },
  ...
  {
    id: 'occupants',
    label: msg`In this room`,
    blurb: msg`Who is here right now, with their status.`,
    slot: 'aside',
    defaultFor: 'all',
    order: 10,
  },
  {
    id: 'hand_queue',
    label: msg`Hands up`,
    blurb: msg`Who wants to speak, in order. Clears itself; nothing is stored.`,
    slot: 'aside',
  ...
  {
    id: 'looking_for_team',
    label: msg`Looking for a team`,
    blurb: msg`Everyone at the event who ticked it, with their skills. Not just this room.`,
    slot: 'aside',
  ...
  {
    id: 'skill_finder',
    label: msg`Find someone`,
    blurb: msg`Search everyone at the event by skill or name.`,
    slot: 'aside',
    defaultFor: ['networking'],
    order: 25,
    hiddenForEventTypes: ['conference'],
  ...
  {
    id: 'mentors_on_duty',
    label: msg`Mentors on duty`,
    blurb: msg`Mentors across the venue, free ones first.`,
    slot: 'aside',
    defaultFor: ['help_desk'],
    order: 30,
  },
  {
    id: 'judges_present',
    label: msg`Judges`,
    blurb: msg`Judges across the venue and whether they are free.`,
    slot: 'aside',
    defaultFor: ['judging'],
    order: 40,
  },
  {
    id: 'help_nudge',
    label: msg`Needs help`,
    blurb: msg`Anyone at the event whose status is “needs help”, and where they are.`,
    slot: 'aside',
    defaultFor: ['help_desk'],
    order: 45,
  },
  {
    id: 'countdown',
    label: msg`Deadline`,
    blurb: msg`Time left to submit. Hidden if the event has no submission deadline.`,
    slot: 'aside',
  ...
  },
  {
    id: 'capacity',
    label: msg`Capacity`,
    blurb: msg`How full the room is. Hidden if it has no limit.`,
    slot: 'aside',
    defaultFor: [],
    order: 55,
  },
  {
    id: 'announcements',
    label: msg`Event announcements`,
    blurb: msg`The organizer updates published for this event.`,
    slot: 'aside',
  ...
  },
  {
    id: 'activity_log',
    label: msg`Room log`,
    blurb: msg`Just the announcements posted in this room, out of the chat scrollback.`,
    slot: 'aside',
    defaultFor: [],
    order: 65,
  },
  {
    id: 'sponsor_links',
    label: msg`Sponsor links`,
    blurb: msg`Buttons the sponsor wants clicked — careers, docs, a demo. Added below.`,
    slot: 'aside',
  ...
  },
  {
    ...
    blurb: msg`A short checklist for a new arrival. Disappears once they finish it.`,
    slot: 'aside',
    defaultFor: [],
    order: 75,
  },
  {
    id: 'wayfinding',
    label: msg`Elsewhere in the venue`,
    blurb: msg`The other rooms, busiest first, with the way back to the map.`,
    slot: 'aside',
  ...
  {
    id: 'venue_headcount',
    label: msg`In the venue`,
    blurb: msg`How many people are at the event and what they are doing.`,
    slot: 'aside',
    defaultFor: [],
    order: 85,
  },
