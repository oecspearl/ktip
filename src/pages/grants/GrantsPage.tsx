...
import { Search, Wallet, ChevronRight, FileText } from 'lucide-solid'
      ...
      <div class="bg-gray-800 min-h-[180px] flex items-center">
        <div class="container mx-auto px-4 py-10">
          <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
              <p class="text-gray-400 text-sm uppercase tracking-widest mb-2">Grant Archives</p>
              <h1 class="text-3xl md:text-4xl font-display font-bold text-white">Grants & Funding</h1>
            </div>
            <div class="flex items-center gap-4">
              <A href="/grants/my-applications">
                <Button icon={<FileText size={16} />} size="sm" class="bg-ktip-ocean-600 text-white hover:bg-ktip-ocean-700 text-sm">
                  My Applications
                </Button>
              </A>
              <nav class="text-sm text-gray-400 hidden md:block" aria-label="Breadcrumb">
                ...
                <span class="text-gray-300">Grants</span>
              </nav>
            </div>
          </div>
        </div>
            ...
            >
              ...
              >
                <div>
                  ...
                  <div>
                    <For each={grants()}>{(grant) => <GrantCard grant={grant} />}</For>
                  </div>
                </div>
              </Show>
            </Show>
